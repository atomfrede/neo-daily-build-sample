...
describe('Artist e2e test', () => {
  ...
  it('should load Artists', async () => {
    ...
    expect(await artistComponentsPage.getTitle()).to.eq('appNeo4JApp.artist.home.title');
  ...
  it('should load create Artist page', async () => {
    ...
    expect(await artistUpdatePage.getPageTitle()).to.eq('appNeo4JApp.artist.home.createOrEditLabel');
  ...
  it('should delete last Artist', async () => {
    ...
    expect(await artistDeleteDialog.getDialogTitle()).to.eq('appNeo4JApp.artist.delete.question');
