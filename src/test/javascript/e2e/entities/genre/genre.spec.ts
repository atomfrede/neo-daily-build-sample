...
describe('Genre e2e test', () => {
  ...
  it('should load Genres', async () => {
    ...
    expect(await genreComponentsPage.getTitle()).to.eq('appNeo4JApp.genre.home.title');
  ...
  it('should load create Genre page', async () => {
    ...
    expect(await genreUpdatePage.getPageTitle()).to.eq('appNeo4JApp.genre.home.createOrEditLabel');
  ...
  it('should delete last Genre', async () => {
    ...
    expect(await genreDeleteDialog.getDialogTitle()).to.eq('appNeo4JApp.genre.delete.question');
