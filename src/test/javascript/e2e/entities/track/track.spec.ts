...
describe('Track e2e test', () => {
  ...
  it('should load Tracks', async () => {
    ...
    expect(await trackComponentsPage.getTitle()).to.eq('appNeo4JApp.track.home.title');
  ...
  it('should load create Track page', async () => {
    ...
    expect(await trackUpdatePage.getPageTitle()).to.eq('appNeo4JApp.track.home.createOrEditLabel');
  ...
  it('should delete last Track', async () => {
    ...
    expect(await trackDeleteDialog.getDialogTitle()).to.eq('appNeo4JApp.track.delete.question');
